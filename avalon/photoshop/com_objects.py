# Taken from https://github.com/lohriialo/photoshop-scripting-python/blob/master/api_reference/photoshop_2020.py
# This may later need to factor in the Photoshop version and platform.
# -*- coding: mbcs -*-
